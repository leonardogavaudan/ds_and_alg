...
def quick_sort_recurse(arr: List[int], low_index: int, high_index: int) -> None:
    ...
    arr[pivot_final_index], arr[high_index] = arr[high_index], arr[pivot_final_index]

    quick_sort_recurse(arr, low_index, pivot_final_index - 1)
    quick_sort_recurse(arr, pivot_final_index + 1, high_index)
